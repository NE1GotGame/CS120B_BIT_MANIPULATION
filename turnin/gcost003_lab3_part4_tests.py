...
tests = [ 
 ...
 {'description': ' PINA:0x00 => PORTB: 0x00, PORTC = 0x00',
    ...
    {'description': ' PINA:0x19 => PORTB: 0x01, PORTC = 0x90',
    'steps': [ {'inputs': [('PINA', 0x19)], 'iterations': 5 } ],
    'expected': [('PORTB', 0x01), ('PORTC', 0x90)],
    },

    {'description': ' PINA:0x3E => PORTB: 0x02, PORTC = 0xE0',
    'steps': [ {'inputs': [('PINA', 0x3E)], 'iterations': 5 } ],
    'expected': [('PORTB', 0x03), ('PORTC', 0xE0)],
    },
    ]
